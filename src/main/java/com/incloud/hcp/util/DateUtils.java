...
public class DateUtils {
    ...
    public static Date obtenerFechaActual() {
        ...
        String sFecha = convertDateToString("dd/MM/yyyy", fechaActual);
        try {
            Date sfechaActual = convertStringToDate("dd/MM/yyyy", sFecha);
            return sfechaActual;
        }
        catch(Exception e) {
            return null;
...
//        }
    ...
    public static LocalDate utilDateToLocalDateWithTime (Date utilDate) {
        if (utilDate == null)
            return null;

        return utilDate.toInstant().atZone(ZoneId.of("UTC-5")).toLocalDate();
    }
